...
class GeCoLogger
{
    ...
    use App\CustomClasses\GeCoLogger;
    ...
    GeCoLogger::writeLog();
    ...
    Ex.:
    GeCoLogger::writeLog(null, 'tried login', $request); [chamado do método authenticate com senha errada]
    => NoID:prof1@ufes.br|tried login|System

    GeCoLogger::writeLog(); [chamando do método authenticate]
    => 7:prof1@ufes.br|authenticate|System

    GeCoLogger::writeLog(); [chamando do método index do UserController]
    => 7:prof1@ufes.br|index|User

    GeCoLogger::writeLog($user); [chamado do método store do UserController]
